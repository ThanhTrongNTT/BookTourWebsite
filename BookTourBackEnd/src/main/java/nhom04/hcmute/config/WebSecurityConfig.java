...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/v1/user/delete/**").permitAll()
                .antMatchers("/api/v1/tour/delete/**").permitAll()
                .antMatchers("/api/v1/location/delete/**").permitAll()
                .antMatchers("/api/v1/booking/delete/**").permitAll()
